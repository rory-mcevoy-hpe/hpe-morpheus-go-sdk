...
// ExpirationPolicyTypeConfiguration3 Configuration settings for the following policy types: - Expiration
...
func (o *ExpirationPolicyTypeConfiguration3) IsSetLifecycleType() bool {
	if o != nil && !IsNil(o.LifecycleType) {
		return true
	}
