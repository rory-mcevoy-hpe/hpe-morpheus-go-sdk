...
// MaxMemoryPolicyTypeConfiguration3 Configuration settings for the following policy types: - Max Memory
...
func (o *MaxMemoryPolicyTypeConfiguration3) IsSetMaxMemory() bool {
	if o != nil && !IsNil(o.MaxMemory) {
		return true
	}
